    ...
    public class ProjectController : Controller
    {
        ...
        public async Task<IActionResult> ProjectAddEdit(int? projectId)
        {
            ...
            if(projectId != null)
            {
                ...
                StudentProjectManagement.Areas.Admin.Models.Project projectData = JsonConvert.DeserializeObject<StudentProjectManagement.Areas.Admin.Models.Project>(responseContent1);
        ...
        #region SaveProject
        [HttpPost]
        public async Task<IActionResult> SaveProject(StudentProjectManagement.Areas.Admin.Models.Project project) 
        {
            setTokenToHeader();
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                return RedirectToAction("AssignMembers", "Project", new { area = "Admin", projectId = resObj, edit = project.ProjectId == 0 ? 0 : 1});
            }
            else
            {
